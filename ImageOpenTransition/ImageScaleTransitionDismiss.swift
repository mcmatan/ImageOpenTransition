...
class ImageScaleTransitionDismiss : NSObject , UIViewControllerAnimatedTransitioning {
    ...
    func getImageFromImageScaleTransitionObject(_ transitionObject : ImageScaleTransitionObject)->UIImageView {
    ...
    func startFrame(_ transitionObject : ImageScaleTransitionObject, withNavigationController : Bool, controllerAnimatingFrom : UIViewController, controllerAnimatingTo : UIViewController)->CGRect {
    ...
    func endFrame(_ transitionObject : ImageScaleTransitionObject, containerView : UIView)->(frame : CGRect , hasSet : Bool) {

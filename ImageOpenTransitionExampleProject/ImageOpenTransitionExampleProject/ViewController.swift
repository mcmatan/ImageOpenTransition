...
import ImageOpenTransition
    ...
    class ViewController: UIViewController , UITableViewDelegate, UITableViewDataSource, UINavigationControllerDelegate{
        ...
        func transitionWithStoryBoard(_ cell : ViewControllerCell, usingNavigationController : Bool) {
        ...
        func transitionNoStoryBoard(_ cell : ViewControllerCell, usingNavigationController : Bool) {
